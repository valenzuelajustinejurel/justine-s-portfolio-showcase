...
const tools = [
  {
    name: "Squarespace",
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8 text-muted-foreground group-hover:text-foreground transition-colors" fill="currentColor">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {tools.map((tool, index) => (
              <motion.div
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-xl bg-card border border-border hover:border-primary/20 shadow-md hover:shadow-xl transition-all duration-300"
              >
